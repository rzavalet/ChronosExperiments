...
export LIBLITMUS=${USERHOME}/Downloads/litmus/liblitmus

#---------------------------------------------------------------------------------
# Add the binaries located in our home to the PATH
#---------------------------------------------------------------------------------
export PATH=${PATH}:${USERHOME}/usr/bin
export LD_LIBRARY_PATH=${USERHOME}/usr/lib:${BDBPATH}/lib:${LIBLITMUS}${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}
echo "PATH=${PATH}"
...
export LDFLAGS="-L${USERHOME}/usr/lib -lstocktrading -lchronosx -L${BDBPATH}/lib -L${LIBLITMUS} -llitmus"
